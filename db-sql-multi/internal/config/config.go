...
func Load() AppConfig {
	return AppConfig{
		MySQL: DBConfig{
			Driver:          "mysql",
			DSN:             mustEnv("MYSQL_DSN", "root:rootpass@tcp(127.0.0.1:3306)/testdb?parseTime=true"),
		...
		PG: DBConfig{
			Driver:          "postgres",
			DSN:             mustEnv("PG_DSN", "postgres://testuser:Test%401234@127.0.0.1:5432/testdb?sslmode=disable"), //password is Test@1234
